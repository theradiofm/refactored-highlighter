...
const kRemoteHost="https://theradiofm.netlify.app/";
const kTimeOut =6000;
...
const kAddToHomeScreenMdText="Add the app to your home screen now to keep on listening!";
const kAddToHomeScreenIosText="Add the app to your home screen now to keep on listening!";
